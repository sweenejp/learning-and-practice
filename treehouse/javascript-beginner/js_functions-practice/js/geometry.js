...
function prism_volume(width, height, length) {
...
console.log(rect_area(5, 22));
console.log(prism_volume(4.5, 12.5, 17.4));
console.log(circle_area(7.2));
console.log(sphere_volume(7.2));
